...
<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"> <a href="{{route('dashboard')}}"><img class="img-fluid for-light" src="../assets/images/logo/logo_dark.png" alt="logo-light"><img class="img-fluid for-dark" src="../assets/images/logo/logo.png" alt="logo-dark"></a></div>
            <div class="toggle-sidebar"> <i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i></div>
        </div>
        <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div> <a class="toggle-sidebar" href="#"> <i class="iconly-Category icli"> </i></a>
                <div class="d-flex align-items-center gap-2 ">
                    <h4 class="f-w-600">Welcome {{Auth::user()->name}}</h4><img class="mt-0" src="{{asset('/assets/images/hand.gif')}}" alt="Hello hand">
                </div>
            </div>
            <div class="welcome-content d-xl-block d-none"><span class="text-truncate col-12">Here’s what you have for today. </span></div>
        </div>
            ...
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown notification-down">
                    <div class="notification-box">
                        ...
                        </svg><span class="badge rounded-pill badge-secondary">{{$counted ?? 0}} </span>
                    </div>
                        ...
                        <div class="card mb-0">
                            <div class="card-header">
                                <div class="common-space">
                                    ...
                                    <div><span>{{$counted ?? 0}} New</span></div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="notitications-bar">
                                    <ul class="nav nav-pills nav-primary p-0" id="pills-tab" role="tablist">
                                        <li class="nav-item p-0"> <a class="nav-link active" id="pills-blog-tab" data-bs-toggle="pill" href="#pills-blog" role="tab" aria-controls="pills-blog" aria-selected="true">
                                                Reservation Requests</a></li>
                                                        ...
                                                        <div class="d-flex w-100 notification-data justify-content-center align-items-center gap-2">
                                                            <div class="flex-grow-1">
                                                                <div class="common-space user-id w-100">
                                                                    <div class="common-space w-100"> <a class="f-w-500 f-12" href="mailto:{{$request->customer_email}}">{{$request->customer_name}}</a></div>
                                                                </div>
                                                                <div><span class="f-w-500 f-light f-12">{{date('l F d', strtotime($request->reservation_date)).' at '.date('h:i A', strtotime($request->reservation_time))}}</span></div>
                                                            </div><span class="f-light f-w-500 f-12">People: x{{$request->members}}</span>
                                                        </div>
                                                    </li>
                                                    @endforeach
