            ...
            <ul class="sidebar-links" id="simple-bar">
                <li class="back-btn">
                    <a href="{{route('dashboard')}}">
                        <img class="img-fluid" src="{{asset('/assets/website/images/logo.png')}}" alt="">
                    </a>
                ...
                <li class="sidebar-main-title">
                    <div>
                        <h6> <span style="text-transform: capitalize">Global Menu</span></h6>
                    </div>
                </li>
                ...
                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="calendar-basic.html">
                        ...
                        <span>Reservation Requests</span><div class="according-menu"><i class="fa fa-angle-right"></i>
                        </div>
                    </a>
                </li>
                                ...
                                <div class="col mega-box">
                                    <div class="link-section">
                                        ...
                                        <ul class="submenu-content opensubmegamenu">
                                            ...
                                            <li><a href="login-bs-validation.html" target="_blank">Login validation</a>
                                            </li>
                                            <li><a href="login-bs-tt-validation.html" target="_blank">Login tooltip</a>
                                            </li>
                                            <li><a href="login-sa-validation.html" target="_blank">Login sweetalert</a>
                                            </li>
