...
<section class="float-left w-100 sub-banner-con postion-relative main-box">
    <figure><img src="{{asset('assets/website/images/sub-banner-vector.png')}}" alt="icon" class="position-absolute sub-vector"></figure>
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6">
                <div class="sub-banner-img-con">
                    <figure><img src="{{asset('assets/website/images/menu-banner-img.jpg')}}" alt="image"></figure>
                    <!-- sub banner img con -->
                </div>
                <!-- col -->
            </div>
